...
import { ConnectionArgs, ListProductResponse, Product } from "../../../interfaces";
...
export function useProductsWithCursor(args:ConnectionArgs, type: string, siteId: string) {
  ...
  return useQuery<ListProductResponse>(["find-products-with-cursor", args, type, siteId], () => findProductsWithCursor(args, type, siteId));
}
