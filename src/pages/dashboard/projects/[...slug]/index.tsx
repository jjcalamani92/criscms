...
import { GridPage0, GridPage1, GridPage2, GridPage3, GridProduct, Home, ProductOverviews, ProductOverviews1 } from '../../../../components'
...
function Page() {
  ...
  switch (asPath) {
    case '/dashboard/projects/6324d2d5132d462bc1c57b55': return <Fragment><Home /></Fragment>
    default:
      return <Custom404 />
  }
}
